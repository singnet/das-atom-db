...
class TestRedisMongoExtra:
    ...
    def test_hashable_document_str(self, redis_mongo_db):
        db = redis_mongo_db
    ...
    @mock.patch("hyperon_das_atomdb.adapters.redis_mongo_db.MongoClient", return_value=mock.MagicMock())
    @mock.patch("hyperon_das_atomdb.adapters.redis_mongo_db.Redis", return_value=mock.MagicMock())
    @mock.patch("hyperon_das_atomdb.adapters.redis_mongo_db.RedisCluster", return_value=mock.MagicMock())
