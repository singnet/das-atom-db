...
struct transformer {
    ...
    static void tuple_to_atom_type(AtomType& atom_type, const transformer::AtomTypeTuple& state) {
    ...
    static void tuple_to_node(Node& node, const transformer::NodeTuple& state) {
    ...
    static void tuple_to_link(Link& link, const transformer::LinkTuple& state) {
