...
def test_get_matched_type_template(db: IAtomDB):
...
def test_get_matched_type(db: IAtomDB):
...
def test_get_matched_node_name(db: IAtomDB):
...
def test_atom_count(db: IAtomDB):
